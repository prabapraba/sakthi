...
class Config
{
    const VENDOR_NAME = "raja/";
    const NAMESPACE_PREFIX = "\\raja\\";
    ...
    protected static $_validInputWidgets = [
        '\raja\typeahead\Typeahead' => ['yii2-widgets', 'yii2-widget-typeahead'],
        '\raja\select2\Select2' => ['yii2-widgets', 'yii2-widget-select2'],
        '\raja\depdrop\DepDrop' => ['yii2-widgets', 'yii2-widget-depdrop'],
        '\raja\touchspin\TouchSpin' => ['yii2-widgets', 'yii2-widget-touchspin'],
        '\raja\switchinput\SwitchInput' => ['yii2-widgets', 'yii2-widget-switchinput'],
        '\raja\rating\StarRating' => ['yii2-widgets', 'yii2-widget-rating'],
        '\raja\file\FileInput' => ['yii2-widgets', 'yii2-widget-fileinput'],
        '\raja\range\RangeInput' => ['yii2-widgets', 'yii2-widget-rangeinput'],
        '\raja\color\ColorInput' => ['yii2-widgets', 'yii2-widget-colorinput'],
        '\raja\date\DatePicker' => ['yii2-widgets', 'yii2-widget-datepicker'],
        '\raja\time\TimePicker' => ['yii2-widgets', 'yii2-widget-timepicker'],
        '\raja\datetime\DateTimePicker' => ['yii2-widgets', 'yii2-widget-datetimepicker'],
        '\raja\daterange\DateRangePicker' => 'yii2-date-range',
        '\raja\sortinput\SortableInput' => 'yii2-sortinput',
        '\raja\money\MaskMoney' => 'yii2-money',
        '\raja\checkbox\CheckboxX' => 'yii2-checkbox',
        '\raja\slider\Slider' => 'yii2-slider',
    ];
